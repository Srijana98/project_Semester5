...
public class LoginFrame extends JFrame {
    ...
    private class LoginButtonListener implements ActionListener {
        ...
        private boolean validateUser(String username, String password) {
            try (Scanner scanner = new Scanner(new File("C:\\Users\\Admin\\eclipse-workspace\\project_Semester5\\src\\project_Semester5\\users.txt"))) {
    ...
    private class RegisterButtonListener implements ActionListener {
        public void actionPerformed(ActionEvent e) {
            ...
            try (PrintWriter out = new PrintWriter(new BufferedWriter(new FileWriter("C:\\Users\\Admin\\eclipse-workspace\\project_Semester5\\src\\project_Semester5\\users.txt", true)))) {
